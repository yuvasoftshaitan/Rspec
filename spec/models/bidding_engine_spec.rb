...
RSpec.describe BiddingEngine do
  describe ".bid!" do
    let(:seller) { User.create(:name => Faker::Name.name, :phone_no => Faker::PhoneNumber.phone_number) }
    let(:bidder) { User.create(:name => Faker::Name.name, :phone_no => Faker::PhoneNumber.phone_number) }
